...
def renomear_questoes_simples():
    pasta = "46-90" # ATUALIZAR com o nome da pasta das questões que você vai arrumar 
    ...
    for i in range(54, 98+1):    # atualize seu for com o número da primeira imagem "parte_AlgumaCoisa.png" até o número da última imagem "parte_AlgumaCoisa.png" mais 1 da pasta
        ...
        novo = f"questao-{i-8}.png" # faça uma conta: se o i do teu for está em 2, e precisa virar questão 35, como você transforma 2 em 35? faça a conta e coloque dentro da concatenação
